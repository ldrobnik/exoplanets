...
export const SELECTION = "&select=pl_hostname,pl_letter,pl_radj,pl_rade,pl_dens,pl_eqt,pl_insol,pl_discmethod,pl_pnum,pl_orbper,pl_orbeccen,pl_orbincl,pl_bmassj,pl_bmasse,st_dist,st_optmag,rowupdate"; //bit of the URL address to select the needed columns
